...
public class GrabInteraction : MonoBehaviour, IInteractable
{
  ...
  public GameObject[] conditionalObjects;    // This is a reference to another gameobjects that are either hidden or unhidden by the act of grabbing the interaction object.
